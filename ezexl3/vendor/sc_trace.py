# sc_trace.py - Vendored from turboderp-org/exllamav3
# Source: https://raw.githubusercontent.com/turboderp-org/exllamav3/master/sc_trace.py
# Vendored for pip-installable distribution (self-sampled calibration trace generator; not included in the exllamav3 wheel)

import sys, os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))  # ezexl3 vendor patch (PYTHONSAFEPATH)
