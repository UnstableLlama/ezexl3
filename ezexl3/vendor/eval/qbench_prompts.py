# qbench_prompts.py - Vendored from turboderp-org/exllamav3
# Source: https://raw.githubusercontent.com/turboderp-org/exllamav3/master/eval/qbench_prompts.py
# Vendored for pip-installable distribution (prompt/template helpers used by sc_trace.py; not included in the exllamav3 wheel)
