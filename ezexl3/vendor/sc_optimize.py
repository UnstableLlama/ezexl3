# sc_optimize.py - Vendored from turboderp-org/exllamav3
# Source: https://raw.githubusercontent.com/turboderp-org/exllamav3/master/sc_optimize.py
# Vendored for pip-installable distribution (per-tensor bitrate recipe optimizer; not included in the exllamav3 wheel)
