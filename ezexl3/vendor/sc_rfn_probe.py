# sc_rfn_probe.py - Vendored from turboderp-org/exllamav3
# Source: https://raw.githubusercontent.com/turboderp-org/exllamav3/master/sc_rfn_probe.py
# Vendored for pip-installable distribution (per-tensor quantization error probe; not included in the exllamav3 wheel)
